## ESSE SCRIPT GERA MODELOS UTILIZANDO TIMESTEPS (JANELA DE CONTEXTO)
...
for i in n_neuronios:
    ...
    model = tf.keras.Sequential([
        tf.keras.layers.LSTM(i, activation=ATIVACAO, return_sequences=True, input_shape=(TIMESTEPS, tx_train.shape[2])),
